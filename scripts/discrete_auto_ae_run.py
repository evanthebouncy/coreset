...
from models.discrete_auto_ae import AEnet_Maker
...
if __name__ == "__main__":
  ...
  if TRAIN:
    ...
    for sub_maker in sub_makers:
      sub_maker.save('saved_models/discrete_auto_ae_model')
  # don't train
  else:
    for i in range(n_labels):
      sub_makers[i].load('saved_models/discrete_auto_ae_model', i)
